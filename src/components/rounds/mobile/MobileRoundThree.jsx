...
const MobileRoundThree = ({players, setPlayers, setRound}) => {
  ...
  const addPreBalance = () => {
    if(input !== '') {
      ...
      updatedPlayers[turn].rounds[2].preBalance = input;
  ...
  const addPostBalance = () => {
    if(input !== '') {
      const updatedPlayers = [...players];
      updatedPlayers[turn].rounds[2].postBalance = input;
      const difference = updatedPlayers[turn].rounds[2].postBalance - updatedPlayers[turn].rounds[2].preBalance;
      const balance = (difference / updatedPlayers[turn].rounds[2].preBalance)
      updatedPlayers[turn].rounds[2].balance = parseFloat(balance.toFixed(3))
  ...
  return (
    <div className='mobileRoundThreeContainer'>
      ...
      <MobileModals isOpenModal={isOpenGameModal} closeModal={closeGameModal}>
        ...
        }
        {
          ...
          <div>
            {
              players[turn].rounds[2].preBalance === 0 && leaderboard === false ?
              <div>
...
export default MobileRoundThree